...
const routes: Routes = [
  ...
  {
    path: 'yourads',
    loadChildren: () => import('./pages/yourads/yourads.module').then( m => m.YouradsPageModule)
  },
  {
    path: 'market',
  ...
  {
    path: 'mainlogin',
    loadChildren: () => import('./pages/mainlogin/mainlogin.module').then( m => m.MainloginPageModule)
  },
  {
    path: 'verifyemail',
